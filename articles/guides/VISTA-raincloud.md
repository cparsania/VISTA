...
#> [1] ggplot2_4.0.2    VISTA_0.99.8     BiocStyle_2.38.0
#> 
#> loaded via a namespace (and not attached):
#>   [1] RColorBrewer_1.1-3          ggrain_0.1.2               
#>   [3] jsonlite_2.0.0              tidydr_0.0.6               
#>   [5] magrittr_2.0.5              ggtangle_0.1.1             
...
#>  [29] igraph_2.2.3                lifecycle_1.0.5            
...
#>  [45] S4Vectors_0.49.1-1          DESeq2_1.50.2              
...
#>  [57] bit64_4.6.0-1               fontquiver_0.2.1           
#>  [59] backports_1.5.1             S7_0.2.1                   
...
#>  [69] rappdirs_0.3.4              DelayedArray_0.36.1        
...
#>  [95] stringr_1.6.0               babelgene_22.9             
#>  [97] limma_3.66.0                yulab.utils_0.2.4          
#>  [99] splines_4.5.3               tweenr_2.0.3               
#> [101] dplyr_1.2.1                 treeio_1.34.0              
...
#> [139] assertthat_0.2.1            pkgdown_2.2.0              
